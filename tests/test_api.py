...
class APITests(unittest.TestCase):
    ...
    def test_collection_endpoint_returns_correct_data(self):
        """Collection endpoint should return the correct data."""
        self.add_tasks()
    ...
    def test_resource_endpoint_returns_correct_data(self):
        """Resource endpoint should return the correct data."""
        self.add_tasks()
    ...
    def test_invalid_resource_endpoint_returns_error(self):
        """Resource endpoint should return error on invalid input."""
        self.add_tasks()
        response = self.app.get(
            '/api/v1/tasks/31415926535897932',
